...
# Loading GWAS
```{r eval=FALSE}
survDementia = fread("/mnt/rreal/RDS/RDS/Raquel/Scherzer/META_ANALYSIS/NEW_2022/metaanalysis_dementia_new_2022.txt.gz")
head(survDementia)
survDementia_raw_maf = fread("/mnt/rreal/RDS/RDS/Raquel/Scherzer/META_ANALYSIS/NEW_2022/SURVIVAL_DEMENTIA_META_4_COHORTS_NEW_2022v1.tbl")
...
# save
fwrite(survDementia_rsID_vbeta, "/mnt/rreal/RDS/RDS/acarrasco/COLLABS/FOR_RAQUEL/harmonised_progtoDemGWAS.txt", quote = F, sep= "\t", col.names=T, row.names=F)
```
...
results_path = "/mnt/rreal/RDS/RDS/acarrasco/COLLABS/FOR_RAQUEL"
...
GWAS_path <- "/mnt/rreal/RDS/RDS/acarrasco/COLLABS/FOR_RAQUEL/harmonised_progtoDemGWAS.txt"
eQTLgene_path <- "/mnt/rreal/RDS/RDS/acarrasco/COLLABS/DATA/eQTLgen/Full_eQTLgen_rsID.MAF.txt"
...
# Path to the GWAS we load
GWAS_path <- "/mnt/rreal/RDS/RDS/acarrasco/COLLABS/FOR_RAQUEL/harmonised_progtoDemGWAS.txt"
psychEnc_path <- "/mnt/rreal/RDS/RDS/acarrasco/COLLABS/DATA/PsychEncode/Full_hg19_cis-eQTL_rsID_MAF.txt"
...
```{r}
results_eQTL <- merge_coloc_summaries("/mnt/rreal/RDS/RDS/acarrasco/COLLABS/FOR_RAQUEL/progtoDementia_eQTLgene",
...
We did not find any loci sharing causal variants between the GWAS and any of eQTLgen and eQTL data from PsychEncode

For LRP1B, we could not find data of it in eQTL gene, ( you can see it yourself typinf the gee name on the datatable), and for PsychEncode, the H4 pp was really small, and the H3 PP > 0.95
