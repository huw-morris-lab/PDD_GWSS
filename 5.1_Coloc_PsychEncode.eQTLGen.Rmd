...
# Loading GWAS
```{r eval=FALSE}
survDementia = fread("/path/to/metaanalysis_dementia.txt.gz") #file used to upload into FUMA
head(survDementia)
survDementia_raw_maf = fread("/path/to/metaanalysis_summary_statistics.tbl")
...
# Path to the GWAS we load
GWAS_path <- "path/to/harmonised_progtoDemGWAS.txt"
psychEnc_path <- "path/to/Full_hg19_cis-eQTL_rsID_MAF.txt"
