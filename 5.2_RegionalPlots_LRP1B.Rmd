...
We are also interested in knowing if there is any variant from the LRP1B loci that regulates alternative splicing. We could not perform coloc because full iso/tQTL data from PsychEncode is not available. Unfortunately, only significant associations from the PsychEncode eQTL data are available, which makes coloc tool inappropiate due to the drastic reduction in sample size.
