...
gtex_cortex_chr3 = arrow::read_parquet("/path/to/DATA/GTEX_V8/gtexv8_download/GTEx_Analysis_v8_QTLs/GTEx_Analysis_v8_EUR_sQTL_all_associations/Brain_Cortex.v8.EUR.sqtl_allpairs.chr3.parquet")
gtex_cortex_chr19 = arrow::read_parquet("/path/to/DATA/GTEX_V8/gtexv8_download/GTEx_Analysis_v8_QTLs/GTEx_Analysis_v8_EUR_sQTL_all_associations/Brain_Cortex.v8.EUR.sqtl_allpairs.chr19.parquet")
```
...
```{r echo=FALSE}
gtex_cortex_merged = fread("/path/to/DATA/GTEX_V8/sQTL_EUR_CORTEX/gtex_proccessed_chr3chr19_noDUPS_V2.txt")
```
...
Let's have a look at the coloc PPs for each gene within +-1MB from LRP1B and APOE lead SNPs
```{r}
...
gtex_cortex_path <- "/path/to/DATA/GTEX_V8/sQTL_EUR_CORTEX/gtex_proccessed_chr3chr19_noDUPS_V2.txt"
